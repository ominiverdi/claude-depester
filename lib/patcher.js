...
// All spinner words used in Claude Code (present-tense, shown while thinking)
// Extracted from Claude Code v2.1.76 binary - 187 words
const MARKER_WORDS = [
  'Accomplishing',
  'Actioning',
  'Actualizing',
...
// All completion verbs used in Claude Code (past-tense, shown as "Baked for 42s" after thinking)
// Extracted from Claude Code v2.1.76 binary - 8 words
